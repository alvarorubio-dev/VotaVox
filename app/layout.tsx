...
const jsonLdWebSite = {
  ...
  url: SITE_CONFIG.url,
  description: 'Iniciativa independiente de simpatizantes para fomentar el voto a VOX en España.',
  inLanguage: 'es-ES',
  publisher: {
    '@type': 'Organization',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="es-ES">
      <head>
        <link rel="icon" type="image/png" href="/mapa_peninsula_iberica_espana.png" />
        <link rel="apple-touch-icon" href="/mapa_peninsula_iberica_espana.png" />
